...
sealed interface Expr {
    ...
    /**
     * Represents a single get member operator expression.
     *
     * @property target The value to index
     * @property member The member to access
     */
    data class GetMember(override val context: Context, val target: Expr, val member: Name) : Expr {
        override fun <X> accept(visitor: Visitor<X>): X =
            visitor.visitGetMemberExpr(this)
    }

    /**
     * Represents a single set member operator expression.
     *
     * @property target The value to index
     * @property member The member to access
     * @property value The value to set
     */
    data class SetMember(override val context: Context, val target: Expr, val member: Name, val value: Expr) : Expr {
        override fun <X> accept(visitor: Visitor<X>): X =
    ...
    interface Visitor<X> {
        ...
        /**
         * Visits an get member expression.
         *
         * @param expr The expression to visit
         */
        ...
        /**
         * Visits a set member expression.
         *
         * @param expr The expression to visit
         */
